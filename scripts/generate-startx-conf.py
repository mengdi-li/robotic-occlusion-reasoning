# Based on https://github.com/allenai/allenact/blob/main/scripts/startx.py
...
if __name__ == "__main__":
    xorg_conf_path = os.path.join(".", "dummy-xorg.conf")
    generate(xorg_conf_path)
